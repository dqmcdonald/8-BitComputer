...
class Signal(Enum):
    ...
    IROU = auto()  # Instruction Register Out: drive the instruction register onto the bus
    ...
    MIIN = auto()  # Memory Address Register In: load the memory address register from the bus
    MIOU = auto()  # Memory Address Register Out: drive the memory address register onto the bus
